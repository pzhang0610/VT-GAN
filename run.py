import os
import argparse
from solver import gaitStarGAN
...
parser.add_argument('--lambda_gp', dest='lambda_gp', type=float, default=10, help='balance parameter for gradient penalty')
parser.add_argument('--lambda_triplet', dest='lambda_triplet', type=float, default=10, help='balance parameter for gradient penalty')
# if-conditions
...
parser.add_argument('--resume_iters', dest='resume_iters',type=int, default=199999, help='Resuming training from RESUME_ITERS')
...
# testing related
parser.add_argument('--dst_angle', dest='dst_angle', type=int, default=0, help='target angle in testing.')
parser.add_argument('--test_dir', dest='test_dir', type=str, default='./generated/20181018', help='target angle in testing.')
...
# directories
parser.add_argument('--sample_dir', dest='sample_dir', type=str, default='./sample/20181006', help='path to store samples in training phase')
parser.add_argument('--model_dir', dest='model_dir', type=str, default='./checkpoint/20181006', help='path to store samples in testing phase')
parser.add_argument('--log_dir', dest='log_dir', type=str, default='./logs/20181006', help='path to logs')
parser.add_argument('--loss_dir', dest='loss_dir', type=str, default='./loss/20181006', help='path to store losses')
